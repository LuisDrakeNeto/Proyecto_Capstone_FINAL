...
model_name = 'alexnet_model'  # Change this to the model you want to load
model_path = f'C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/AlexNet/{model_name}.h5'
...
# Adjust input size to (227, 227) to match model.input_shape
target_size = (227, 227)  # Size matching the model
