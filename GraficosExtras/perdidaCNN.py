...
model_name = 'cnn_model'  # Change this to the model you want to load
model_path = f'C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/CNN_Standard/{model_name}.h5'
...
# Adjust input size to (128, 128) to match model.input_shape
target_size = (128, 128)  # Size matching the model
