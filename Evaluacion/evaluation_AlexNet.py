...
root = tk.Tk()
root.title("AlexNet Evaluation - ROC AUC and Metrics")
root.geometry("1200x800")
root.configure(bg="#f0f0f0")

# Title label
label_title = tk.Label(root, text="Evaluation Results - AlexNet", font=("Arial", 20, "bold"), bg="#f0f0f0", fg="#333")
...
# Prepare the test set (AlexNet expects 227x227 images)
test_generator = test_datagen.flow_from_directory(
    'C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/Validacion',
    target_size=(227, 227),  # AlexNet expects 227x227 images
    batch_size=32,
...
alexnet_model = load_model('C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/AlexNet/alexnet_model.h5')

# Function to calculate and display metrics
def evaluate_model():
    text_area.insert(tk.END, "Evaluating AlexNet...\n\n")
...
btn_evaluate = tk.Button(root, text="Evaluate AlexNet", command=evaluate_model, font=("Arial", 14), bg="#4CAF50", fg="white", padx=20, pady=10)
