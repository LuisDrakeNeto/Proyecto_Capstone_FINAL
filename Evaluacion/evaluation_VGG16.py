...
root = tk.Tk()
root.title("VGG16 Evaluation - ROC AUC and Metrics")
root.geometry("1200x800")
root.configure(bg="#f0f0f0")

# Title label
label_title = tk.Label(root, text="Evaluation Results - VGG16", font=("Arial", 20, "bold"), bg="#f0f0f0", fg="#333")
...
# Prepare the test set (VGG16 expects 224x224 images)
...
vgg16_model = load_model('C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/VGG16/VGG16_model.h5')

# Function to calculate and display metrics
def evaluate_model():
    text_area.insert(tk.END, "Evaluating VGG16...\n\n")
...
btn_evaluate = tk.Button(root, text="Evaluate VGG16", command=evaluate_model, font=("Times New Roman", 14), bg="#4CAF50", fg="white", padx=20, pady=10)
