...
root = tk.Tk()
root.title("ResNet152 Evaluation - ROC AUC and Metrics")
root.geometry("1200x800")
root.configure(bg="#f0f0f0")

# Title label
label_title = tk.Label(root, text="Evaluation Results - ResNet152", font=("Arial", 20, "bold"), bg="#f0f0f0", fg="#333")
...
# Prepare the test set (ResNet152 expects 224x224 images)
test_generator = test_datagen.flow_from_directory(
    'C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/Validacion',
    target_size=(224, 224),  # ResNet152 expects 224x224 images
    batch_size=32,
...
resnet152_model = load_model('C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/ResNet152/resnet152_model.h5')

# Function to calculate and display metrics
def evaluate_model():
    text_area.insert(tk.END, "Evaluating ResNet152...\n\n")

    # Predictions
    predictions = resnet152_model.predict(test_generator)
...
btn_evaluate = tk.Button(root, text="Evaluate ResNet152", command=evaluate_model, font=("Arial", 14), bg="#4CAF50", fg="white", padx=20, pady=10)
