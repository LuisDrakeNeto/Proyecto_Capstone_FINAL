...
root = tk.Tk()
root.title("Standard CNN Evaluation - ROC AUC and Metrics")
root.geometry("1200x800")
root.configure(bg="#f0f0f0")

label_title = tk.Label(root, text="Evaluation Results - Standard CNN", font=("Arial", 20, "bold"), bg="#f0f0f0", fg="#333")
...
test_generator = test_datagen.flow_from_directory(
    ...
    target_size=(128, 128),  # Adjust if your CNN uses a different image size
    batch_size=32,
    class_mode='categorical',
    shuffle=False
)

cnn_model = load_model('C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/CNN_Standard/cnn_model.h5')

def evaluate_model():
    text_area.insert(tk.END, "Evaluating Standard CNN...\n\n")
...
btn_evaluate = tk.Button(root, text="Evaluate Standard CNN", command=evaluate_model, font=("Times New Roman", 14), bg="#4CAF50", fg="white", padx=20, pady=10)
