...
model = tf.keras.models.load_model('C:/Users/USER/Documents/UPN 10 CICLO/CAPSTONE PROJECT/PROYECTO PYTHON/ModelosEntrenados/DenseNet201/densenet201_model.h5')
...
def validar_y_renderizar(archivo):
    ...
    try:
        ...
        img.load()  # Asegurarse de que la imagen se carga completamente
        return img, None  # Si es válida, devolver la imagen y nada en el mensaje
    except (UnidentifiedImageError, AttributeError, IOError):
        # Si no es una imagen válida, devolver None para la imagen y un mensaje de error
        return None, f"""
